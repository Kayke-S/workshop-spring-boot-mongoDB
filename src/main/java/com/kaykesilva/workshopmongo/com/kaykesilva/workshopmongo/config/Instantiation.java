...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, fmt.parse("21/03/2018"), "Partiu Viajem!", "Vou viajar pra São Paulo. Abraços!", maria);
		Post post2 = new Post(null, fmt.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!", maria);
